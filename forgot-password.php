...
$stmt=$mysqli->prepare("SELECT email,contact,password FROM stdreg WHERE (email=? && contact=?) ");
...
{ ?>
					...
					<?php }  ?>
								<form action="" class="mt" method="post">
									...
									<input type="text" placeholder="Contact" name="contact" class="form-control mb">
