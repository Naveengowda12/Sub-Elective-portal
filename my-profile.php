...
$query="update  stdreg set usn=?,name=?,sem=?,contact=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssisi',$usn,$name,$sem,$contact,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="usn" id="usn"  class="form-control" required="required" value="<?php echo $row->usn;?>" >
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">sem : </label>
<div class="col-sm-8">
