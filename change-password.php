...
$udate=date('d-m-Y h:i:s', time());;
	$sql="SELECT password FROM stdreg where password=?";
	...
	if($row_cnt>0)
	{
		$con="update stdreg set password=?,passUdateDate=?  where id=?";
...
<?php $result ="SELECT passUdateDate FROM stdreg WHERE id=?";
